...
import { Brain, Mail, Lock, Eye, EyeOff, Chrome, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-navy-900 flex items-center justify-center px-4 py-16">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-1/3 right-1/3 w-72 h-72 bg-cyan-500/10 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2.5 mb-6 group">
            <div className="p-2.5 rounded-xl bg-gradient-to-br from-violet-600 to-cyan-500 shadow-lg group-hover:shadow-violet-500/40 transition-all">
        ...
        <div className="glass-card p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Email */}
            <div>
              <label className="block text-white/60 text-sm mb-1.5" htmlFor="login-email">
                Email Address
              </label>
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                <label className="text-white/60 text-sm" htmlFor="login-password">
                  Password
                </label>
